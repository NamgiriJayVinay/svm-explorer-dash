            ...
            children=[
                ...
                dcc.Tab(
                    ...
                    children=html.Div(className='control-tab', children=[
                        html.H4(className='what-is', children='What is Support Vector Machine?'),
                        html.P('“Support Vector Machine” (SVM) is a supervised machine learning algorithm which can be used for both classification or regression challenges. However,  it is mostly used in classification problems. In the SVM algorithm, we plot each data item as a point in n-dimensional space (where n is number of features you have) with the value of each feature being the value of a particular coordinate. Then, we perform classification by finding the hyper-plane that differentiates the two classes very well '),
                        html.P(
                            ...
                            children=[
                                drc.Card(
                                    ...
                                    children=[
                                        ...
                                        html.H5(className='what-is', children='Select Dataset'),
                                                 dcc.Dropdown(
...
#Custom template callbacks for rgression analysis
